<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayAT.aspx.cs" Inherits="UIUXAsp.PayAT" %>
...
<body>
  ...
  <div style="width: 399px; height: 88px; left: 746px; top: 715px; position: absolute; background: #06429D; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border-radius: 9px">
            <asp:Button ID="Button1" runat="server" BackColor="#000099" Font-Bold="True" Font-Size="XX-Large" ForeColor="White" Height="84px" OnClick="Button1_Click" Text="Pay 9999" Width="399px" />
  </div>
  <div style="width: 460px; height: 662px; left: 113px; top: 189px; position: absolute; background: linear-gradient(160deg, #4AA8FE 100%, rgba(246.09, 249.89, 202.41, 0.59) 0%); box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.25); border-radius: 64px"></div>
            <asp:Image ID="Image3" runat="server" style="width: 437px; height: 643px; left: 124px; top: 199px; position: absolute; box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.25); border-radius: 64px" ImageUrl="~/images/v197_1511.png" />
</div>
        </div>
    </form>
</body>
