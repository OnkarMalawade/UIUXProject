<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayJPT.aspx.cs" Inherits="UIUXAsp.PayJPT" %>
...
<body>
  ...
  <div style="width: 399px; height: 88px; left: 746px; top: 715px; position: absolute; background: #06429D; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border-radius: 9px">
            <asp:Button ID="Button1" runat="server" BackColor="#000099" Font-Bold="True" Font-Size="XX-Large" ForeColor="White" Height="84px" OnClick="Button1_Click" Text="Pay 7999" Width="399px" />
  </div>
  ...
  <asp:Image ID="Image3" runat="server" style="width: 437px; height: 643px; left: 124px; top: 199px; position: absolute; box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.25); border-radius: 64px" ImageUrl="~/images/v197_1766.png" />
</div>
        </div>
    </form>
</body>
