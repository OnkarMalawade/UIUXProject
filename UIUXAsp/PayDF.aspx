<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayDF.aspx.cs" Inherits="UIUXAsp.PayDF" %>
...
<body>
  ...
  <div style="width: 460px; height: 662px; left: 113px; top: 189px; position: absolute; background: linear-gradient(160deg, #4AA8FE 100%, rgba(246.09, 249.89, 202.41, 0.59) 0%); box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.25); border-radius: 64px"></div>
            <asp:Image ID="Image3" runat="server" style="width: 437px; height: 643px; left: 124px; top: 199px; position: absolute; box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.25); border-radius: 64px" ImageUrl="~/images/v197_1715.png" />
</div>
        </div>
    </form>
</body>
