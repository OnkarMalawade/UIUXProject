<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayAN.aspx.cs" Inherits="UIUXAsp.PayAN" %>
...
<body>
  ...
  <div style="width: 1440px; height: 172px; left: 0px; top: -1px; position: absolute; background: #043277; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25)"></div>
  <div style="width: 101px; height: 55px; left: 732px; top: 75px; position: absolute; color: #FDFDFF; font-size: 24px; font-family: Inder; font-weight: 400; word-wrap: break-word">Home</div>
  ...
  <asp:Image ID="Image2" runat="server" style="width: 367px; height: 327px; left: 761px; top: 336px; position: absolute" ImageUrl="~/images/v197_1611.png" />
  ...
  <div style="width: 399px; height: 88px; left: 746px; top: 715px; position: absolute; background: #06429D; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border-radius: 9px">
            <asp:Button ID="Button11" runat="server" BackColor="#000099" Font-Bold="True" Font-Size="XX-Large" ForeColor="White" Height="84px" OnClick="Button1_Click" Text="Pay 11999" Width="399px" />
  </div>
  ...
  <asp:Image ID="Image3" runat="server" style="width: 437px; height: 643px; left: 124px; top: 199px; position: absolute; box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.25); border-radius: 64px" ImageUrl="~/images/v197_1562.png" />
</div>
        </div>
    </form>
</body>
