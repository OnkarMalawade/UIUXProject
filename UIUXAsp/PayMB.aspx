<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayMB.aspx.cs" Inherits="UIUXAsp.PayMB" %>
...
<body>
  ...
  <asp:Image ID="Image3" runat="server" style="width: 437px; height: 643px; left: 124px; top: 199px; position: absolute; box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.25); border-radius: 64px" ImageUrl="~/images/v197_1868.png" />
</div>
        </div>
    </form>
</body>
